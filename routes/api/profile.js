...
router.delete('/experience/:exp_id', auth, async (req, res) => {
    try {
        ...
        const newExps = profile.experience.filter(exp => exp._id != req.params.exp_id);
...
router.put('/education',
    [
        auth,
        [
            check('institution', 'Institution is requied').not().isEmpty(),
            check('degree', 'Degree is requied').not().isEmpty(),
            check('field', 'Field of study is requied').not().isEmpty(),
            check('from', 'From date is requied').not().isEmpty()
        ]
    ], async (req, res) => {
        const errors = validationResult(req);
...
router.delete('/education/:exp_id', auth, async (req, res) => {
    try {
        ...
        const newEdus = profile.education.filter(exp => exp._id != req.params.exp_id);
